package com.example.demoshopmarcin.MockedData;
...
public class MockedCategoriesSource {
    ...
    private List<Category> initializeCategories() {
        try {
            List<String> strings = Resources.readLines(Resources.getResource("/basicData/kategorie.txt"), Charset.forName("UNICODE"));
